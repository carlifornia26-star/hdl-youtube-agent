...
const GROUNDING_LIBRARY = {
  ...
  "bitcoin-standard": [
    ...
    { type: "book", fact: "the book breaks Bitcoin's security down to the cryptographic primitives underneath it — SHA-256 hashing, ECDSA and Schnorr signatures, and the elliptic curve math that actually guarantees a coin can't be forged", source: "Bitcoin Infrastructure, Ch. 3: Cryptographic Primitives and Monetary Sovereignty" },
    { type: "book", fact: "it includes a full institutional-grade self-custody audit protocol and a catalog of over 100 documented wallet and hardware failure modes, each paired with its own recovery path", source: "Bitcoin Infrastructure, Ch. 7 & Ch. 11" },
    { type: "book", fact: "one entire chapter is built around reading a live mempool for fee-timing and trading signals, rather than just treating fees as a fixed cost", source: "Bitcoin Infrastructure, Ch. 9: Node Operations and Mempool Intelligence" },
  ],
